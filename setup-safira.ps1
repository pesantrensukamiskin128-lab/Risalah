...
Write-Host "  Pastikan MySQL sudah berjalan!" -ForegroundColor Yellow
Write-Host "  Default: root/password@localhost:3306" -ForegroundColor Yellow
Write-Host ""
...
Write-Host "  Klik dua kali JALANKAN.bat" -ForegroundColor White
